...
public class ReviewController {
   ...
   /** 리뷰등록페이지로 이동 */
   @GetMapping("/review")
   public String write(@RequestParam(value="no") String campsite_no, @RequestParam(value="nm") String facltNm, Model model, @AuthenticationPrincipal PrincipalDetails principalDetails) {
      model.addAttribute("no", campsite_no);
      model.addAttribute("facltNm", facltNm);
      Member dto = principalDetails.getMember();
      String campNm = facltNm;
      model.addAttribute("dto", dto);
      model.addAttribute("campNm", campNm);
   ...
   public String write(ReviewDto dto, Model model) {
      ...
      if (result == 1) {
         ...
         model.addAttribute("no",dto.getCampsiteNo());
   ...
   public String update(ReviewDto dto, String reviewNo, @AuthenticationPrincipal PrincipalDetails principalDetails, Model model) {
   ...
   public String delete(String reviewNo, @AuthenticationPrincipal PrincipalDetails principalDetails, Model model) {
